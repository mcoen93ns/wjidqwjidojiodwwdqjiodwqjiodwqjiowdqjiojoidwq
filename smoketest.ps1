...
function CheckGithubActions() {
    Write-Host "Checking github actions to see if the pipeline has run successfully"
        ...
        $response = gh api -X GET repos/mcoen93NS/wjidqwjidojiodwwdqjiodwqjiodwqjiowdqjiojoidwq/actions/runs
    } until ($response -contains "completed")
...
Write-Host "Running smoke test for wjidqwjidojiodwwdqjiodwqjiodwqjiowdqjiojoidwq"
